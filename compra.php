                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($linha = mysqli_fetch_assoc($pesquisar)) {
                                    ...
                                    echo "
                                        <tr class='table-light'>
                                            ...
                                            <td>{$linha['valor']}</td>
                                            <td>
                                                <form method='post' action='./controller/excluir_compra.php' onsubmit='return confirm(\"Deseja realmente excluir esta compra?\");'>
